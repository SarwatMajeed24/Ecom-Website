    ...
    <div className="w-full md:py-16">
      <div className="flex gap-[5px] justify-center">
          ...
          <div className="flex gap-[5px] justify-center">
            {product.images?.map((item: any, i: number) => (
              <Image
                ...
                alt={`Product Image ${i}`} // Updated alt for better accessibility
                width={220}
                height={100}
        ...
        <div className="flex flex-col gap-8 md:pt-32 pt-0">
          ...
          <button
            className="text-black md:px-5 md:py-3 px-2 py-1 text-xl border box-border border-gray-900 hover:bg-black hover:text-white"
            onClick={() => addProduct(product, qty)}
          >
            Add To Cart
          </button>
